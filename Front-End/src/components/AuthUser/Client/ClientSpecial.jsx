...
const pageStyle = {
  backgroundColor: '#fff3e0', // Creamy background color similar to coffee cream
  padding: '20px', // Optional padding to ensure content does not touch the edges
  minHeight: '100vh', // Ensures the background color covers the full viewport height
  width: '100%', // Ensures the background color covers the full width
};
...
const tableContainerStyle = {
  ...
  margin: '20px 10%',
  maxWidth: '80%',
  backgroundColor: '#F3E0C6'  // Updated to Cappuccino Cream
};
